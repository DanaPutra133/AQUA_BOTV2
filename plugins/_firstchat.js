...
${banned ? `Kamu *Terbanned* Kak 😨\nHubungi: wa.me/${owner[0]}` : `Saya ${wm} Bot Yang Dibuat Oleh Dana Untuk membantu pekerjaan anda sehari-hari \n *jangan melakukan spam perintah ya* \n\n kalau mau sewa bot langsung ke .owner ya :) 🚀`}
`.trim(), m)
    user.pc = new Date * 1
}
